...
if (!function_exists('vivi_mag_product_format_function')) {

	function vivi_mag_product_format_function() {
		...
		if ( vivi_mag_postmeta( '_sale_price' ) ) :	
											
			$html .= '<span class="onsale">'.esc_html__( 'Sale!', 'vivi-mag').'</span>';
	...
	add_action( 'vivi_mag_product_format', 'vivi_mag_product_format_function' );
