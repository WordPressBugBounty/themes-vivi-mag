...
if( !class_exists( 'vivi_mag_metaboxes' ) ) {

	class vivi_mag_metaboxes {
		...
		public function __construct( $posttype, $fields = array() ) {
			...
			add_action( 'save_post', array( &$this, 'vivi_mag_metaboxes_save' ) );
		}
		...
		public function metaboxes_panel() {
			...
			case 'navigation': ?>
				...
				<div id="tabs" class="vivi_mag_metaboxes">
				...
				switch ( $field['type'] ) { 
					...
					<div class="vivi_mag_inputbox">
						...
						<div class="input-right">
							...
							<input name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" value="<?php if ( vivi_mag_postmeta( $field['id']) != "") { echo esc_attr(vivi_mag_postmeta( $field['id'])); } ?>" />
					...
					<div class="vivi_mag_inputbox">
						...
						<div class="input-right">
							...
							<select name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" >
								...
								<option <?php if ( vivi_mag_postmeta($field['id']) == $option || ( !vivi_mag_postmeta($field['id']) && $field['std'] == $option )) { echo 'selected="selected"'; } ?> value="<?php echo esc_attr($option); ?>"><?php echo esc_html($values); ?></option><?php } ?>  
					...
					<div class="vivi_mag_inputbox">
                        ...
                        <div class="input-right">
                            ...
                            <textarea name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" ><?php if ( vivi_mag_postmeta( $field['id']) != "") { echo stripslashes(vivi_mag_postmeta( $field['id'])); } ?></textarea>
		...
		public function vivi_mag_metaboxes_save() {
